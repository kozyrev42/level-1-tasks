                    ...
                    <div class="panel-content">
                        <div class="panel-content">
                            <div class="form-group">
                                ...
                                <a href="task_17_auth_form.php" class="btn btn-info">Войти в приложение</a>
                                <?php else:?>
                                <!-- иначе сессия содержит пользователя -->
                                <div class="alert alert-success fade show" role="alert">
                                    Здравствуйте, <?php echo $_SESSION['user']['email']?> !
                                </div>
                                <a href="task_17_logout.php" class="btn btn-info">Выйти</a>
                                <?php endif;?>
